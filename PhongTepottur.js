...
var shadingModel = 1;  // 0 = Phong, 1 = Blinn-Phong (default)
...
///////////////////////
    var shadingModelLoc = gl.getUniformLocation(program, "shadingModel");
    gl.uniform1i(shadingModelLoc, shadingModel);


     document.getElementById("toggleShading").onclick = function() {
    shadingModel = 1 - shadingModel; // skiptir milli 0 og 1
    gl.uniform1i(shadingModelLoc, shadingModel);
    console.log("Shading model:", shadingModel == 0 ? "Phong" : "Blinn-Phong");
    };
///////////////////////
