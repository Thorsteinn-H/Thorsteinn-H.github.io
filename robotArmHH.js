     ...
     window.addEventListener("keydown", function(e){
         switch( e.keyCode ) {
            ...
            case 88:	// x - snýr stöpli afturábak
                ...
                break;
            case 65:	// a - snýr neðri armi (aukinn fram)
			    theta[1] = Math.min(90, theta[1]+5);   // clamp við +90
                break;
            case 83:	// s - snýr neðri armi (aftur)
			    theta[1] = Math.max(-90, theta[1]-5);  // clamp við -90
                break;
            case 81:	// q - snýr efri armi (aukinn fram)
			    theta[2] = Math.min(179, theta[2]+5);  // innan við 180
                break;
            case 87:	// w - snýr efri armi (aftur)
			    theta[2] = Math.max(-179, theta[2]-5); // innan við -180
                break;
            case 69:    // e - snýr litla hand/enda-bút fram
                theta[3] = Math.min(179, theta[3]+5);
                break;
            case 82:    // r - snýr litla hand/enda-bút aftur
                theta[3] = Math.max(-179, theta[3]-5);
                break;
         }
     }  );  
...
var render = function() {
    ...
    // Setja hand/enda-bútinn á rangt stað miðað við enda efri arms
